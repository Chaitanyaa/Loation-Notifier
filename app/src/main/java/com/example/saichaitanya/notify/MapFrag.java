...
/**
 * Created by SAI CHAITANYA on 15-07-2015.
 */
...
public class MapFrag extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        map.moveCamera(CameraUpdateFactory.newLatLng(MainActivity.start));
