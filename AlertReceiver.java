...
public class AlertReceiver extends BroadcastReceiver implements LocationListener{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        //dista=Float.parseFloat(MainActivity.distance.substring(0,MainActivity.distance.length()-3));
        //MainActivity.locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 0, 0, this);
        //String url = getDirectionsUrl(MainActivity.start, MainActivity.end);
    ...
    public void onLocationChanged(Location location) {
        MainActivity.start=new LatLng(location.getLatitude(),location.getLongitude());
    }
            ...
            for(int i=0;i<result.size();i++){
                ...
                for(int j=0;j<path.size();j++){
                    ...
                    if(j==0){    // Get distance from the list
                        MainActivity.distance = (String)point.get("distance");
                        continue;
